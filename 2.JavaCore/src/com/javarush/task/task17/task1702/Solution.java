...
public class Solution {
    ...
    static {
        for (int i = 0; i < Solution.testArray.length; i++) {   // инициализация testArray числами от 0 до 999
            testArray[i] = i;
        }
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1000 - 1; i >= 0; i--) {                   // наполняем расширяемую строку числами от 999 до 0 через пробел
